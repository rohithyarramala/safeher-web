      ...
      <main className="flex-1 p-4 md:p-8 md:ml-72">
        <section className="glass-shell rounded-3xl p-5 md:p-7 mb-6">
          ...
          <p className="text-[#7e5f97] mt-1">
            Your direct safety network for calls, alerts, and location sharing.
          </p>
        </section>
            ...
            <tbody>
              {contacts.map((contact) => (
                <tr key={contact.phone}>
                  ...
                  <td>
                    <span
                      className={`safeher-pill ${contact.priority === "Primary" ? "safeher-pill-pink" : "safeher-pill-indigo"}`}
                    >
                      {contact.priority}
                    </span>
                  </td>
