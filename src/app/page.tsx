...
const flows = [
  {
    ...
    title: "Detect",
    detail:
      "AI evaluates route context, community alerts, and environment risk signals in real time.",
    icon: <Radar size={18} />,
  },
  {
    step: "02",
    title: "Protect",
    detail:
      "One-tap SOS sends location, starts secure recording, and alerts your trusted circle instantly.",
  ...
  },
  {
    ...
    title: "Respond",
    detail:
      "Prioritized escalation paths connect family, local responders, and helplines with context.",
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <Image
              ...
              width={42}
              height={42}
              className="rounded-full border border-[#f3d9ea]"
            />
            <div>
              <p className="font-black text-[#604188] tracking-wide leading-tight">
                SAFEHER
              </p>
              <p className="text-[11px] font-semibold text-[#9d6a97] leading-tight">
                Built for women, designed for confidence
              </p>
            </div>
          </Link>
          <nav className="hidden lg:flex items-center gap-7 text-sm font-bold text-[#7b5c95]">
            <a href="#features" className="hover:text-[#b54f8f] transition">
              Features
            </a>
            <a href="#how" className="hover:text-[#b54f8f] transition">
              How it works
            </a>
            <a href="#intelligence" className="hover:text-[#b54f8f] transition">
              Safety intelligence
            </a>
          </nav>
          <div className="hidden md:flex items-center gap-2 md:gap-3">
            <Link
              href="/login"
              className="px-4 py-2 rounded-xl text-sm font-bold text-[#7f5f98] hover:bg-[#fff2f9] transition"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="safeher-btn-primary px-4 md:px-5 py-2 text-sm md:text-base"
            >
              Create Account
            </Link>
          </div>
            ...
            >
              <div className="pt-3 flex flex-col gap-2 text-sm font-bold text-[#7b5c95]">
                <a
                  ...
                  className="rounded-xl px-3 py-2 hover:bg-[#fff2f9]"
                >
                  Features
                </a>
                <a
      ...
      <main>
        <section className="max-w-7xl mx-auto px-4 md:px-8 pt-10 md:pt-16 pb-10 md:pb-16 grid lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-8 md:gap-12 items-center">
          <motion.div {...rise}>
            ...
            <p className="text-base md:text-lg text-[#7b5c95] max-w-2xl leading-relaxed mb-8">
              SafeHer combines predictive intelligence, instant SOS workflows,
              trusted-circle coordination, and evidence capture into one elegant
              platform made for real daily life.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                href="/signup"
                className="safeher-btn-primary px-6 py-3 text-base flex items-center gap-2"
              >
                Start Free <ArrowRight size={18} />
              </Link>
              <Link
                href="/dashboard"
                className="px-6 py-3 rounded-xl border border-[#e7d4e6] bg-white font-bold text-[#74558f] hover:bg-[#fff4fa] transition"
              >
                Open Demo Dashboard
              </Link>
            </div>
            <div className="mt-8 flex flex-wrap gap-2 text-sm text-[#8a6a9f] font-semibold">
              <span className="safeher-pill safeher-pill-indigo">
                <Globe size={13} /> Localized risk signals
              </span>
              <span className="safeher-pill safeher-pill-pink">
                <MapPin size={13} /> Route-aware alerts
              </span>
              <span className="safeher-pill safeher-pill-green">
                <CheckCircle2 size={13} /> Trusted response network
              </span>
            </div>
          </motion.div>
            ...
            <div className="safeher-card-soft rounded-[2rem] md:rounded-[2.5rem] p-4 md:p-6 relative overflow-hidden">
              ...
              <div className="relative glass-shell rounded-[1.5rem] p-4 md:p-5">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <p className="text-sm font-black text-[#5d3e82]">
                      SafeHer Live Preview
                    </p>
                    <p className="text-xs text-[#8d6da2]">
                ...
                <div className="safeher-card p-3 mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="text-sm font-bold text-[#5d3e82]">
                        Safety Orbit
                      </p>
                      <p className="text-xs text-[#8d6da2]">
                        Trusted circle synced 22s ago
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div className="safeher-card p-3">
                    <p className="text-xs font-bold text-[#8d6da2]">
                      Threat index
                    </p>
                ...
                <div className="safeher-card p-3">
                  <p className="text-xs font-bold text-[#8d6da2] mb-2">
                    Rapid actions
                  </p>
                  <div className="grid grid-cols-3 gap-2 text-[11px] font-bold text-center">
                    <span className="rounded-lg bg-[#ffe9f4] py-1.5 text-[#ae4d89]">
                      SOS
                    </span>
                    <span className="rounded-lg bg-[#ece5ff] py-1.5 text-[#6655b0]">
                      Share
                    </span>
                    <span className="rounded-lg bg-[#e3f8ef] py-1.5 text-[#2f8d6f]">
                      Call
                    </span>
                  </div>
                </div>
        ...
        <section className="border-y border-[#ecd8e7] bg-white/70">
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-10 grid grid-cols-2 md:grid-cols-4 gap-5">
            {kpis.map((item) => (
              ...
              >
                <p className="text-2xl md:text-3xl font-black text-[#5e3f82]">
                  {item.value}
                </p>
                <p className="text-[11px] md:text-xs uppercase tracking-wider font-bold text-[#9673a9] mt-1">
                  {item.label}
                </p>
              </motion.article>
            ))}
        ...
        >
          <motion.div {...rise} className="mb-8 md:mb-10">
            <h2 className="text-3xl md:text-5xl font-black text-[#4f336f] mb-3">
              How SafeHer Works
            </h2>
            <p className="text-[#7b5c95] max-w-3xl">
              A practical three-stage safety loop that turns awareness into
              rapid support when it matters most.
            </p>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-4 md:gap-5">
            {flows.map((item, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <span className="text-3xl font-black text-[#e5d6f0]">
                    {item.step}
                  </span>
                  <span className="safeher-pill safeher-pill-indigo">
        ...
        <section
          id="features"
          className="bg-gradient-to-br from-[#5b3e84] to-[#b35190] py-14 md:py-20"
        >
          <div className="max-w-7xl mx-auto px-4 md:px-8">
            <motion.div
              {...rise}
              className="text-center text-white mb-9 md:mb-12"
            >
              <h2 className="text-3xl md:text-5xl font-black mb-3">
                Capabilities Built for Real Situations
              </h2>
              <p className="text-[#f6ddf0] max-w-2xl mx-auto">
                Every module is designed to reduce response delay and increase
                confidence through clear workflows.
              </p>
            </motion.div>
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4">
              {capabilities.map((item, index) => (
                ...
                >
                  <div
                    className={`w-11 h-11 rounded-xl bg-gradient-to-br ${item.tone} flex items-center justify-center mb-4`}
                  >
                    {item.icon}
                  </div>
        ...
        <section
          id="intelligence"
          className="max-w-7xl mx-auto px-4 md:px-8 py-14 md:py-20 grid xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-6 md:gap-8"
        >
          <motion.article
            {...rise}
            className="safeher-card p-5 md:p-6 overflow-x-auto"
          >
            <div className="flex items-center justify-between gap-4 mb-4">
              <div>
                <h3 className="text-2xl font-black text-[#5e3f82]">
                  Live Intelligence Snapshot
                </h3>
                <p className="text-sm text-[#8a6a9f]">
                  Illustrative operations stream for demonstration.
                </p>
              </div>
              <span className="safeher-pill safeher-pill-green">
                Operational
              ...
              <tbody>
                {miniIncidents.map((row) => (
                  <tr key={row.area}>
                    ...
                    <td>
                      <span
                        className={`safeher-pill ${row.level === "High" ? "safeher-pill-pink" : row.level === "Medium" ? "safeher-pill-indigo" : "safeher-pill-green"}`}
                      >
                        {row.level}
                      </span>
                    </td>
          ...
          <motion.aside {...rise} className="safeher-card p-5 md:p-6">
            <h3 className="text-2xl font-black text-[#5e3f82] mb-4">
              Quick Helplines
            </h3>
            <div className="space-y-3">
              {helplines.map((item) => (
                <div
                  key={item.number}
                  className="safeher-card-soft p-3.5 flex items-center justify-between"
                >
                  <div>
                    <p className="text-xs font-bold text-[#8a6a9f]">
                      {item.label}
                    </p>
                    <p className="text-xl font-black text-[#5e3f82]">
                      {item.number}
                    </p>
                  </div>
                  <a
                    href={`tel:${item.number}`}
                    className="w-10 h-10 rounded-full bg-white border border-[#e6d3e5] flex items-center justify-center text-[#6c59b5] hover:bg-[#f9f3ff] transition"
                  >
                    <PhoneCall size={16} />
                  </a>
                </div>
            ...
            <Link
              ...
              className="safeher-btn-primary mt-5 w-full py-2.5 text-center block"
            >
              View full directory
            </Link>
          </motion.aside>
          ...
          >
            ...
            <div className="relative text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-5xl font-black leading-tight mb-4">
                Build your personal safety network in under two minutes.
              </h2>
              <p className="text-[#f5dced] mb-8 text-base md:text-lg">
                Add trusted contacts, activate your response flow, and start
                navigating with more clarity and support.
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                <Link
                  href="/signup"
                  className="px-6 py-3 rounded-xl bg-white text-[#613f84] font-black hover:opacity-95 transition"
                >
                  Create Free Account
                </Link>
                <Link
                  href="/dashboard"
                  className="px-6 py-3 rounded-xl border border-white/40 font-bold hover:bg-white/10 transition"
                >
                  Explore Dashboard
                </Link>
              </div>
