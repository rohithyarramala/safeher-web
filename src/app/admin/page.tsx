    ...
    <div className="safeher-page md:flex">
      ...
      <main className="flex-1 p-4 md:p-8 md:ml-72">
        <section className="glass-shell rounded-3xl p-5 md:p-7 mb-6">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-[#4f336f]">
            Safety Operations Dashboard
          </h1>
          <p className="text-sm md:text-base text-[#7e5f97] mt-1 mb-6">
            Track user safety signals, platform health, and operational response
            timelines.
          </p>
          <StatsGrid />
        </section>
