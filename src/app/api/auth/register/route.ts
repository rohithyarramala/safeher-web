...
export async function POST(req: NextRequest) {
  ...
  const contacts = Array.isArray(payload?.contacts) ? (payload.contacts as EmergencyContact[]) : [];
  ...
  return NextResponse.json({
    message: 'Registration successful. Verify your email before login if confirmation is enabled.',
